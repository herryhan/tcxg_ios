...
- (void)addLeftBarButtonWithImage:(UIImage *)image WithTitle:(NSString *)title action:(SEL)action{
    ...
    firstButton.frame = CGRectMake(0, 0, 70, 30);
    [firstButton setImage:image forState:UIControlStateNormal];
    [firstButton setTitle:title forState:UIControlStateNormal];
    
    [firstButton setTitleEdgeInsets:UIEdgeInsetsMake(0, -firstButton.imageView.image.size.width, 0, firstButton.imageView.image.size.width)];
    [firstButton setImageEdgeInsets:UIEdgeInsetsMake(0, firstButton.titleLabel.bounds.size.width, 0, -firstButton.titleLabel.bounds.size.width)];
...
- (void)addRightBarButtonWithFirstImage:(UIImage *)firstImage WithTitle:(NSString *)title action:(SEL)action{
...
- (void)addRightBarButtonItemWithTitle:(NSString *)itemTitle andWidth:(CGFloat)width action:(SEL)action
{
    
    UIButton *rightbBarButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, width, 44)];
