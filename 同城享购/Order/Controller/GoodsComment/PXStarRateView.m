...
#define ForegroundStarImage @"star2"
#define BackgroundStarImage @"star1"

typedef void(^completeBlock)(CGFloat currentScore);

@interface PXStarRateView()
...
- (void)layoutSubviews {
    ...
    __weak PXStarRateView *weakSelf = self;
